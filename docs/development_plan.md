...
| Phase 4 - Simulation and testbench system | Complete | Add repeatable simulation commands, module testbenches, and waveform flow |
| Phase 5 - Instruction test programs | Current | Add directed instruction programs and small end-to-end CPU programs |
...
Phase 5 is focused on directed instruction-level test programs for the existing
single-cycle RV32I CPU. The single-cycle CPU remains the active architecture;
pipelining, hazards, and additional ISA expansion are later-phase work.
